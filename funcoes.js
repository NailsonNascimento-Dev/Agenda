...
btn_home.addEventListener("click",(evt)=>{
    ...
    abriAba(evt.target,"./home.html");
 
});
btn_novo.addEventListener("click",(evt)=>{
    abriAba(evt.target,"./novo.html");
    
});
btn_pesquisar.addEventListener("click",(evt)=>{
    abriAba(evt.target,"./pesquisar.html");
  });
btn_gestao.addEventListener("click",(evt)=>{
    abriAba(evt.target, "./gestao.html");
   
});
btn_sobre.addEventListener("click",(evt)=>{
    abriAba(evt.target, "./sobre.html"); 
});

const abriAba=(el,url)=>{
